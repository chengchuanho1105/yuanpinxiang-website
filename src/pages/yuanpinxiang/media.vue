...
defineOptions({ name: 'ChuanLife-Media' })
...
<template>
  <div class="max-w-7xl mx-auto p-8">
    ...
    <div class="text-center mb-16">
      <h1 class="text-5xl font-bold text-gray-900 dark:text-white mb-4">媒體介紹</h1>
      <p class="text-xl text-gray-600 dark:text-gray-400">透過影音與文章，深入了解源品香</p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-lg overflow-hidden">
      ...
      <div class="p-4">
        ...
        <div v-if="activeTab === 'articles'" class="relative">
          <!-- 外層包覆區塊 -->
          <div ref="articleWrapperRef" class="relative overflow-hidden transition-[max-height] duration-700 ease-in-out"
